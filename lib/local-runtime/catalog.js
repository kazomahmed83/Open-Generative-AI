...
function normalizeApiModel(provider, model) {
  return {
    ...
    defaultQuality: model.defaultQuality || (Array.isArray(model.qualityOptions) && model.qualityOptions[0]) || null,
    sizeMap: model.sizeMap || null,
  };
}
...
module.exports = { listCatalog, getCatalogEntry, normalizeApiModel };
